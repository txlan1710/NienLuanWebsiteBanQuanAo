...
<head>
    ...
    <link rel="stylesheet" href="StyleWeb/account.css" />
    ...
    <div id="main-body">
        ...
        <main class="account">
            <div class="main-account">
                <img class="avt-accoutnt" src="Ao/Thiết kế chưa có tên.png">
                <hr>
                <div class="customer_sidebar">
                    <p class="customer-sidebar-title">Thông tin tài khoản</p>
                    <div class="customer-form">
                        <div class="form-group">
                            <label class="lb-form">Họ và tên</label>
                            <input type="text" name="customer[name]" value="xuan lan">
                        </div>
                        <div class="form-group">
                            <label class="lb-form">Email</label>
                            <input type="text" name="customer[email]" value="lan ta">
                        </div>
                        <div class="form-group">
                            <label class="lb-form">Số điện thoại</label>
                            <input type="text" name="customer[phone]" value="0941027800">
                        </div>
                        <div class="form-group">
                            <label class="lb-form">Địa chỉ</label>
                            <input type="text" name="customer[address]" value="0941027800">
                        </div>
                        <div class="form-action">
                            <a href="#" class="btn-account">Thay đổi</a>
                        </div>
                    </div>
                </div>
            </div>
